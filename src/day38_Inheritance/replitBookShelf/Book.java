...
public class Book {
    ...
    public static boolean isTitleWord(String word) {
        // TODO
        List<String> notTittle = new ArrayList<>();

        boolean result = false;

        notTittle.addAll(Arrays.asList("a", "an", "the", "and", "but", "for", "nor", "or", "so", "yet", "at", "by", "in", "into", "near", "of", "on", "to", "than", "via"));

      //  String[] words = word.split(" ");

       // if (words.length==1){

            for (String s : notTittle) {
