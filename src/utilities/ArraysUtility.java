...
public class ArraysUtility {
    ...
    //returns maximum number from the int array
    ...
    //returns minimum number from the int array
    ...
    //returns minimum number from the double array
    ...
    public static boolean contains(int[] array, int element){
        ...
        for (int each:array){
            if (each==element) //if any array element is matching with the given element, it means the given element is in the array
                result=true;
        }
        return result;
    }
    ...
    public static double[] uniqueElements(double[] array) {
        ...
        for (double each : array) {
            if (ArraysUtility.frequencyOfElement(array, each) == 1) {//bif the frequency is one, the element is unique
                result = ArraysUtility.addElement(result, each);
            }
    ...
    //merge the given two array and returns the new array
