...
public class MedianNumber {
    ...
    public static void main(String[] args) {
        ...
        1.if b is bigger than c & b is smaller than a then b is medium number.
        2.if b is bigger than a &  b is smaller than c then  b is medium number.
        ...
        in order to c to be medium number , both previous condition  must be false.
